import {BOX_WIDTH, BOX_HEIGHT} from "./config.js";
...
export default [
    ...
    [[371, 45], [724, 404], [[0, 100, BOX_WIDTH, 16, 1], [0, 216, BOX_WIDTH, 16, 0], [0, 332, BOX_WIDTH, 16, 1], [0, 448, BOX_WIDTH, 32, 0]], [], [[10,10,30,300,1]], []],
    // https://cl.ly/a75111WIDTH1a8
    [[24, 200], [724, 244], [[0, 288, 330, 192, 1], [438, 288, 330, 192, 0]], []],
    // https://cl.ly/ffd71d417828
    [[23, 250], [724, 268], [[0, 312, BOX_WIDTH, 8, 1], [380, 0, 8, 312, 1], [0, 408, BOX_WIDTH, 72, 0]], []],
    ...
    [[24, 390], [604, 152], [[0, 448, BOX_WIDTH, 32, 1], [128, 320, 512, 8, 1], [632, 328, 8, 120, 1], [128, 192, 512, 8, 1], [128, 200, 8, 120, 1], [640, 384, 128, 8, 0], [0, 256, 128, 8, 0]], []],
    // https://cl.ly/c3c9ccaf76a3
    [[16, 275], [566, 248], [[0, 0, BOX_WIDTH, 64, 1], [0, 64, 128, 192, 1], [0, 324, 248, 92, 1], [0, 416, BOX_WIDTH, 64, 1], [192, 132, 180, 96, 1], [440, 64, 100, 224, 1], [620, 112, 72, 245, 1], [192, 228, 56, 96, 1], [300, 288, 320, 69, 1]], []],
    ...
    [[16, 239], [724, 244], [[0, 288, BOX_WIDTH, 192, 1], [336, 0, 96, 288, 1]], []],
    ...
    [[24, 64], [724, getRandomInt(128, 416)], [[0, getRandomInt(128, 352), BOX_WIDTH, 2, true]],
    ...
    [[12, 312], [725, 307], [
        [0, 152, BOX_WIDTH, 72, true],
        [0, 362, 64, 8, true],
        [192, 362, 128, 8, true],
        [448, 362, 128, 8, true],
        [704, 362, 64, 8, true]
    ], [
        [0, 224, BOX_WIDTH, 8, true, 'down'],
    ]],
